...
because every request comes through the sidecar. Monster is production and runs
`main` only: never check out a branch there. There is no CI: test a branch locally
